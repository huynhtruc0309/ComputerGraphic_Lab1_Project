...
namespace vehinh
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            color_user_color = Color.Black;//gangiatri ban dau
            sh_shape = 0;
            flag = 1;
        ...
        private void btBangMau_Click(object sender, EventArgs e)
        {
            if (colorDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                else fill_color = colorDialog1.Color;
            } 
        }
        ...
        private void openGLControl_OpenGLDraw(object sender, SharpGL.RenderEventArgs args)
        {
            ...
            gl.Color(color_user_color.R/255.0, color_user_color.G / 255.0, color_user_color.B / 255.0,0); 
            if (sh_shape == 0)
            {
                //ve duong thang
            }
        ...
        private void veHinhTamGiacDeu(Point pStart, Point pEnd)
        {

        }

        private void veHinhNguGiacDeu(Point pStart, Point pEnd)
        {

        }

        private void veHinhLucGiacDeu(Point pStart, Point pEnd)
        {
